window.__require = function e(t, n, r) {
  ...
  FLang: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "19819UeetVBdp9hSwPD07Sh", "FLang");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Image1_1 = require("./Image1");
    ...
    var FLang = function() {
      function FLang(pkg) {
        ...
        this.action = {};
        fgui.createLabel = function(node) {
          return node.addComponent(Label1_1.Label1);
        };
        fgui.createImage = function(node) {
          return node.addComponent(Image1_1.Image1);
        };
        this.initSprite(pkg);
        this.initFont(pkg);
        this.initLabel(pkg);
      }
      FLang.prototype.getContentStr = function(key) {
      ...
      FLang.prototype.initFont = function(pkg) {
        var items = pkg._items;
        var self = this;
        var mapFontsByName = {};
        for (var iI = 0; iI < items.length; iI++) {
          var item = items[iI];
          if (5 != item.type) continue;
          var font = pkg.getItemAsset(item);
          font["@name"] = item.name;
          mapFontsByName[item.name] = font;
          cc.log("Font init", item.name, font);
        }
        var mapFontConfig = {
          "font-aguda-black": {
            vi: "font-aguda-black",
        ...
        var _a = Object.getOwnPropertyDescriptor(Label1_1.Label1.prototype, "font"), setFont = _a.set, getFont = _a.get;
        var countInit = 0;
        Object.defineProperty(Label1_1.Label1.prototype, "font", {
          set: function(f) {
            var lb = this;
            ...
            action = {
              apply: function() {
                if (!lb.isValid) {
                  lb["@actionFont"] = void 0;
                  delete self.action[key];
                  return;
                }
      ...
      FLang.prototype.initLabel = function(pkg) {
        var _a = Object.getOwnPropertyDescriptor(Label1_1.Label1.prototype, "string"), setString = _a.set, getString = _a.get;
        var countInit = 0;
        var self = this;
        Object.defineProperty(Label1_1.Label1.prototype, "string", {
          set: function(s) {
            var lb = this;
            var actionFont = lb["@actionFont"];
            actionFont && actionFont.apply();
            ...
            self.action[key] = action;
            countInit++;
            cc.log("Label1", path, content_key, self.getContentStr(content_key));
          },
          get: function() {
      ...
      FLang.prototype.initSprite = function(pkg) {
        ...
        for (var iI = 0; iI < items.length; iI++) {
          ...
          for (var iL = 0; iL < langConfig.length; iL++) {
            ...
            if (!mapImage.hasOwnProperty(key)) {
              mapImage[key] = {
                id: key
              };
              ...
              if (d) {
                ...
                s["@lang"] = mapImage[key];
              } else mapImage[key][self.langDefault] = spriteFrame;
            }
            mapImage[key][lang] = spriteFrame;
            spriteFrame["@lang"] = mapImage[key];
          }
        }
        var _a = Object.getOwnPropertyDescriptor(Image1_1.Image1.prototype, "spriteFrame"), setSpriteFrame = _a.set, getSpriteFrame = _a.get;
        var countInit = 0;
        Object.defineProperty(Image1_1.Image1.prototype, "spriteFrame", {
          set: function(s) {
            var image = this;
            var lang = s["@lang"];
            ...
            if (lang) {
              var key_1 = "i" + countInit;
              action = {
                apply: function() {
                  if (!s.isValid) {
                    delete image["@actionLang"];
                    return;
                  }
                  var sTo = lang[self.langCurrent];
                  sTo && setSpriteFrame.call(image, sTo);
                },
                remove: function() {
                  image["@actionLang"] = void 0;
                  delete self.action[key_1];
                }
              };
              image["@actionLang"] = action;
              self.action[key_1] = action;
              countInit++;
              setSpriteFrame.call(image, lang[self.langCurrent]);
            } else setSpriteFrame.call(image, s);
          },
          get: function() {
      ...
      FLang.prototype.applyLang = function(lang) {
        this.langCurrent = lang;
        var action = this.action;
        Object.keys(action).forEach(function(key) {
          var item = action[key];
          item && item.apply && item.apply();
        });
      };
      return FLang;
    }();
  ...
  Image1: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9e1cbWWq8JAd6SkNLUV/5o/", "Image1");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    })(FillOrigin = exports.FillOrigin || (exports.FillOrigin = {}));
    var FlipType;
    (function(FlipType) {
    ...
    })(FlipType = exports.FlipType || (exports.FlipType = {}));
      ...
      Object.defineProperty(Image.prototype, "flip", {
        ...
        set: function(value) {
          if (this._flip != value) {
            this._flip = value;
            var sx = 1, sy = 1;
            this._flip != FlipType.Horizontal && this._flip != FlipType.Both || (sx = -1);
            this._flip != FlipType.Vertical && this._flip != FlipType.Both || (sy = -1);
            1 == sx && 1 == sy || this.node.setAnchorPoint(.5, .5);
      ...
      Object.defineProperty(Image.prototype, "grayed", {
        ...
        set: function(value) {
          ...
          if (value) {
            ...
            material || (material = cc.Material.getBuiltinMaterial("2d-gray-sprite"));
            material = cc.Material.getInstantiatedMaterial ? this._graySpriteMaterial = cc.Material.getInstantiatedMaterial(material, this) : this._graySpriteMaterial = cc.Material.create(material, this);
          } else {
            material = this._spriteMaterial;
            material || (material = cc.Material.getBuiltinMaterial("2d-sprite", this));
            material = cc.Material.getInstantiatedMaterial ? this._spriteMaterial = cc.Material.getInstantiatedMaterial(material, this) : this._spriteMaterial = cc.Material.create(material, this);
          }
    ...
    var Image1 = function(_super) {
      ...
      Image1 = __decorate([ ccclass ], Image1);
      return Image1;
    }(cc.Sprite);
  ...
  Label1: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "bc37em9mHNKP5rnhTkh32js", "Label1");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var Label1 = function(_super) {
      __extends(Label1, _super);
      function Label1() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this._isLockColor = false;
        _this._colorLock = new cc.Color();
        _this._N$file = void 0;
        return _this;
      }
      Label1.prototype.lockColor = function(hex) {
        this._isLockColor = true;
        this._colorLock.fromHEX(hex);
      };
      Label1.prototype.unlockColor = function() {
        if (!this._isLockColor) return;
        this._isLockColor = false;
      };
      Object.defineProperty(Label1.prototype, "color", {
        get: function() {
          if (this._isLockColor) return this._colorLock;
      ...
      Object.defineProperty(Label1.prototype, "font", {
        ...
        set: function(value) {
          if (!value || this.font === value) return;
          this._N$file = value;
      ...
      Label1 = __decorate([ ccclass ], Label1);
      return Label1;
    }(cc.Label);
  ...
  SbCom: [ function(require, module, exports) {
    ...
    var SbCom = function() {
      ...
      SbCom.prototype.initUI = function(pkg) {
        var _this = this;
        var lang = new FLang_1.FLang(pkg);
        var rootCom = new FaryguiInput_1.FaryguiInput(this.node);
        var com = pkg.createObject("Main");
        ...
        tgLang.onClick(function() {
          lang.applyLang(tgLang.selected ? "tl" : "vi");
        }, this);
        var data = [];
        var items = [];
  ...
  SbLoader: [ function(require, module, exports) {
    ...
    var SbLoader = function(_super) {
      ...
      SbLoader.prototype.initUI = function() {
        var pkg = fgui.UIPackage.getByName("Sb");
        var comCtrl = new SbCom_1.SbCom(this.node);
        comCtrl.initUI(pkg);
      };
  ...
  Spine: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "17253cO9btIPqytz+D+b44E", "Spine");
    "use strict";
    cc.Class({
  ...
  TestSpine: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "99d08FTBR9J9IoR4GiyhkFf", "TestSpine");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var TestSpine = function(_super) {
      __extends(TestSpine, _super);
      function TestSpine() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.spine = null;
        return _this;
      }
      TestSpine.prototype.start = function() {
        this.spine.setAnimation(0, "attack", false);
        var dt = .2;
        this.spine._skeleton.update(dt);
        this.spine._state.update(dt);
        this.spine._state.apply(this.spine._skeleton);
      };
      __decorate([ property(sp.Skeleton) ], TestSpine.prototype, "spine", void 0);
      TestSpine = __decorate([ ccclass ], TestSpine);
      return TestSpine;
    }(cc.Component);
...
}, {}, [ "BagDemo", "BasicsDemo", "ChatDemo", "CooldownDemo", "DemoEntry", "EmojiParser", "GuideDemo", "HitTestDemo", "JoystickDemo", "JoystickModule", "ListEffectDemo", "LoopListDemo", "MailItem", "MainMenu", "ModalWaitingDemo", "PullToRefreshDemo", "ScrollPaneDemo", "ScrollPaneHeader", "TestWin", "TransitionDemo", "TreeViewDemo", "VirtualListDemo", "FLang", "FaryguiInput", "FaryguiListEx", "FaryguiUtil", "GListEx", "Image1", "Label1", "Runable", "SbCom", "SbLoader", "Spine", "TestSpine" ]);